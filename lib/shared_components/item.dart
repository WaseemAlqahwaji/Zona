                ...
                Expanded(
                    child: Column(
                      ...
                      Text(
                        ...
                        style:
                            TextStyle(color: Colors.grey, fontFamily: 'steve'),
                      ),
                      const SizedBox(
                        height: 10,
                      ),
...
class ListItemHistory extends StatefulWidget {
  const ListItemHistory(
      {Key? key, required this.item, required this.onClick, this.icon});
          ...
          children: [
            ...
            Expanded(
                child: Column(
                  ...
                  Text(
                    localization.product,
                    style: TextStyle(color: Colors.grey, fontFamily: 'steve'),
                  ),
                  const SizedBox(
                    height: 10,
                  ),
