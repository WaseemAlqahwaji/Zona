...
import '../../../../../login/VerifyCodeScreen.dart';
                        ...
                        ? MaterialButton(
                            ...
                            onPressed: () {
                              if (key.currentState!.validate()) {
                                ...
                                http.post(
                                    Uri.parse(ApiPath.baseAuthUrl + "register"),
                                    body: {
                                  ...
                                  if (value.reasonPhrase == 'OK') {
                                    ...
                                    Navigator.of(context).push(Routing()
                                        .createRoute(VerifyCodeScreen(
                                            email: emailController.text)));
                                  } else if (value.reasonPhrase ==
                                      "Bad Request") {
                                    showTopSnackBar(
                                        context,
                                        CustomSnackBar.error(
                                            message: localization
                                                    .anotherAccountUsesThisEmail +
                                                '\n' +
                                                localization
                                                    .pleaseTryAnotherOne));
                                    setState(() {
